...
parcelRequire = (function (modules, cache, entry, globalName) {
  ...
  return newRequire;
})({"node_modules/roughjs/dist/rough.umd.js":[function(require,module,exports) {
var define;
...
var _rough = require("roughjs/dist/rough.umd");
...
var ctx = (0, _rough.canvas)(canv);
var colors = ["rgb(255, 111, 97)", "rgb(107, 91, 149)", "rgb(42, 75, 124)", "rgb(38, 78, 54)", "rgb(121, 123, 58)", "rgb(42, 41, 62)", "rgb(254, 132, 14)"];
...
function () {
  ...
  _createClass(Nodes, [{
    ...
    value: function drawNodes() {
      var n = this.n;
      var x = this.w / this.n.length;

      for (var i = 1; i <= n.length; i++) {
        var r = Math.abs(Math.floor(i % 7) - 6);
        console.log(r); //const r = Math.floor(Math.random() * 7);
      ...
      for (var i = 1; i <= n.length; i++) {
        for (var j = 1; j <= n[i - 1]; j++) {
          for (var k = 1; k <= n[i]; k++) {
            var y1 = this.h / n[i - 1];
            var y2 = this.h / n[i];
            var h1 = Math.min(x, y1) / 4;
            var h2 = Math.min(x, y2) / 4;
            var x1t = x * i - x / 2;
            var y1t = y1 * j - y1 / 2;
            var x2t = x * (i + 1) - x / 2;
            var y2t = y2 * k - y2 / 2;
...
function setI(t) {
  ...
  var v = t.value.split(' ').filter(function (x) {
    return x !== "";
...
},{"roughjs/dist/rough.umd":"node_modules/roughjs/dist/rough.umd.js"}],"../../../AppData/Roaming/npm/node_modules/parcel/src/builtins/hmr-runtime.js":[function(require,module,exports) {
...
if ((!parent || !parent.isParcelRequire) && typeof WebSocket !== 'undefined') {
  ...
  var ws = new WebSocket(protocol + '://' + hostname + ':' + "31024" + '/');
...
//# sourceMappingURL=/neural-network-diagram.e31bb0bc.js.map